      ...
      <DocumentTitle title="Mill Valley & Recommendations | Kelly & Micah">
        <div>
          <section className="info-section">
            <h3 className="info-section__title">Transportation</h3>
          ...
          <section className="info-section">
            <h3 className="info-section__title">Restaurants</h3>
            <img className="info-section__image" src="/images/solfood.jpg" />
            <p className="info-section__body">
          ...
          <section className="info-section">
            <h3 className="info-section__title">Brunch Spots</h3>
            <p className="info-section__body">
          ...
          <section className="info-section">
            <h3 className="info-section__title">Bars</h3>
            <img className="info-section__image" src="/images/beerworks.jpg" />
            <p className="info-section__body">
